...
<!-- ================ header section end ================= -->	
  <!-- ================ start banner area ================= -->	
  <section class="contact-banner-area" id="about">
  ...
  <div class="row align-items-center">
    ...
    <div class="col-lg-7">
      <div class="welcome-content">
        ...
        <a class="button button--active home-banner-btn mt-4" href=" ">Discover More</a>
      </div>
    </div>
  </div>
</div>
...
<section class="section-margin">
  ...
  <div class="section-intro text-center pb-80px">
    ...
    <h2>Kirana Holidays On Media</h2>
  </div>
  ...
  <div class="row">
    <div class="col-md-6 col-lg-4 mb-4 mb-md-0">
      <div class="card card-news">
        <div class="card-news__img">
          <img class="card-img" src="{{asset('img/p34.jpg')}}" alt="">
        </div>
      </div>
    </div>
    ...
    <div class="col-md-6 col-lg-4 mb-4 mb-md-0">
      <div class="card card-news">
        <div class="card-news__img">
          <img class="card-img" src="{{asset('img/p36.jpg')}}" alt="">
        </div>
      </div>
    </div>
    ...
    <div class="col-md-6 col-lg-4 mb-4 mb-md-0">
      <div class="card card-news">
        <div class="card-news__img">
          <img class="card-img" src="{{asset('img/p35.jpg')}}" alt="">
        </div>
      </div>
    </div>
  </div>
